...
**Getting Started**
1. First Homer has to be downloaded on the Apple App Store or Google Play Store. The links to download Homer can be found [here](https://apps.apple.com/us/app/homer-shn-qo/id1506388041){:target="_blank"} for Apple users and [here](https://play.google.com/store/apps/details?id=sg.gov.homer&hl=en_SG){:target="_blank"} for Android users. 
...
**Report Submission**
9.	Homer will remind users to submit location reports multiple times a day.
